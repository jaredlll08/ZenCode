...
public class ExpressionFindingExpressionVisitor implements ExpressionVisitor<Optional<Expression>> {
	...
	@Override
	public Optional<Expression> visitCapturedDirect(CapturedDirectExpression expression) {
		return Optional.of(expression);
	}
	...
	@Override
	public Optional<Expression> visitCast(CastExpression expression) {
	...
	@Override
	public Optional<Expression> visitConst(ConstExpression expression) {
		return Optional.of(expression);
	}
	...
	@Override
	public Optional<Expression> visitGetter(GetterExpression expression) {
		return expression.target.accept(this);
	}
	...
	@Override
	public Optional<Expression> visitNew(NewExpression expression) {
		return Optional.of(expression);
	}
	...
	@Override
	public Optional<Expression> visitSetter(SetterExpression expression) {
		return Optional.of(expression);
	}

	@Override
	public Optional<Expression> visitStaticGetter(StaticGetterExpression expression) {
		return Optional.of(expression);
	}

	@Override
	public Optional<Expression> visitStaticSetter(StaticSetterExpression expression) {
		return Optional.of(expression);
	}
